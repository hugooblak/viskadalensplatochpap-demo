...
/**
 * Title: Part: header
 * Slug: viskadalensplatochpap/part-header
 * Inserter: no
 *
...
$vi_menu = get_posts( array( 'post_type' => 'wp_navigation', 'title' => 'Main menu', 'numberposts' => 1, 'fields' => 'ids', 'post_status' => 'publish' ) );
$vi_ref  = $vi_menu ? '"ref":' . (int) $vi_menu[0] . ',' : '';
?>
...
<div class="wp-block-group"><!-- wp:navigation {<?php echo $vi_ref; // phpcs:ignore ?>"overlayMenu":"mobile","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} /-->

<!-- wp:paragraph {"className":"vi-phone","style":{"typography":{"lineHeight":"1.2"}}} -->
<p class="vi-phone" style="line-height:1.2"><a href="tel:<?php echo esc_attr( vi_lead( 'telefon_tel' ) ); ?>"><?php echo esc_html( vi_lead( 'telefon' ) ); ?></a><small>Vi svarar vard. 07–18</small></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"className":"vi-header-btn"} -->
<div class="wp-block-buttons vi-header-btn"><!-- wp:button {"className":"vi-track-cta"} -->
<div class="wp-block-button vi-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/offert' ) ); ?>">Boka besiktning</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
